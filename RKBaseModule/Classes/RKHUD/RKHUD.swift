...
public class RKHUD: UIView {
    ...
    private func setupSize() {
        ...
        if let text = labelStatus?.text, animationType == .none {
...
private class ProgressView: UIView {
    ...
    var color: UIColor = UIColor(red: 0, green: 0, blue: 0, alpha: 0.2) {
        didSet { setupLayers() }
    }
